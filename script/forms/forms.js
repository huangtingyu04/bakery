(function ($) {
    $(document).ready(function () {
        ...
        $(".input-field, .text-value, .radio-box").each(function () {
            ...
            if ($ckeditor.length) {
                $this.parents("[class*='col-']").addClass('has-ckeditor');
            }
        });
        ...
        if ($dp.length) {
            $('.datepicker').datetimepicker({
                ...
                'dp.change': function () {
                    // neil 2019-05-12 觸發 oninput event，因為觸發 onchange 不知道為什麼 vue 偵測不到
        ...
        $(this).each(function () {
            ...
            var appendOptionWithIcon = function (select, option, type) {
                ...
                if (!!icon_url) {
                    ...
                    options.append($('<li class="' + disabledClass + optgroupClass + '" data-value="' + optionValue + '"><img alt="" src="' + icon_url + '"' + classString + '><span>' + multipleCheckbox + option.html() + '</span></li>'));
                    return true;
                }
                ...
                if (!!icon_font) {
                    ...
                    // Check for multiple type.
                    options.append($('<li class="' + disabledClass + optgroupClass + '" data-value="' + optionValue + '"><span><i class="cc ' + icon_font + '"></i>' + multipleCheckbox + option.html() + '</span></li>'));
                    return true;
                }
                //cc 20180704 end
                ...
                if (!!palce_name && !!palce_color) {
                    ...
                    // Check for multiple type.
                    options.append($('<li data-name=' + palce_name + ' data-color=' + palce_color + ' class="' + disabledClass + optgroupClass + '" data-value="' + optionValue + '"><span>' + multipleCheckbox + option.html() + '</span></li>'));
                    return true;
                }
                if (!!palce_name && !palce_color) {
                    // var classString = '';
                    ...
                    // Check for multiple type.
                    options.append($('<li data-name=' + palce_name + ' class="' + disabledClass + optgroupClass + '" data-value="' + optionValue + '"><span>' + multipleCheckbox + option.html() + '</span></li>'));
                    return true;
                }
                //huashan custom cc 20180723 end

                // Check for multiple type.
                options.append($('<li class="' + disabledClass + optgroupClass + '" data-value="' + optionValue + '"><span>' + multipleCheckbox + option.html() + '</span></li>'));
            };
            ...
            if (selectChildren.length) {
                selectChildren.each(function () {
                    if ($(this).is('option')) {
                        ...
                        options.append($('<li class="optgroup" data-value="' + optionValue + '"><span>' + $(this).attr('label') + '</span></li>'));
            ...
            var activateOption = function (collection, newOption, firstActivation) {
                if (newOption) {
                    ...
                    if (!firstActivation) {
                        // neil 2019-05-05 變更原 select 值並觸發 onchange event
                        let evt;
                        try {
                            evt = CustomEvent('change');
                        }catch(e) {
                            evt=new CustomEvent('change');
                        }
                        $select.val(newOption.data('value'))[0].dispatchEvent(evt);
                    }
                }
            };
